                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    ...
                                    {{-- <div class="product-action-1">
                                        ...
                                        <a aria-label="Add To Wishlist" class="action-btn hover-up"  href="#" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->sale_price}})"><i class="fi-rs-shopping-bag-add"><i class="fi-rs-heart"></i></a>
                        ...
                        <div class="widget-header position-relative mb-20 pb-10">
                            ...
                            <div class="single-post clearfix">
                                ...
                                <div class="content pt-10">
                                    <h5><a href="{{route('shop')}}">{{$nproduct->name}}</a></h5>
