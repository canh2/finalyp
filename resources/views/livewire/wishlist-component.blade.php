                    ...
                    <div class="product-cart-wrap mb-30">
                        ...
                        <div class="product-content-wrap">
                            ...
                            <div class="product-price">
                              ...
                              {{--  <span class="old-price">{{$item->model->price}}</span> --}}
                             </div>
                          ...
                          <a button="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store({{$item->model->id}},'{{$item->model->name}}',{{$item->model->sale_price}})"><i class="fi-rs-shopping-bag-add"></i></a>
                            </div>
                        </div>
